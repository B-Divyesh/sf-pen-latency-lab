...
- Files: `site/public/stroke-slab-v1.webp` plus 720px and 480px responsive WebP derivatives
...
The 1200×630 social card is a centered crop of that original still. The PNG app icons are raster versions of the hand-authored SVG mark. ImageMagick created these local derivatives; no new stock or third-party assets were added.
